...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden bg-zinc-950 w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 70deg at center top, #3b82f6, transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          style={{
            backgroundImage: `conic-gradient(from 290deg at center top, transparent, transparent, #3b82f6)`,
          }}
